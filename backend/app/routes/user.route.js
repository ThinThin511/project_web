...
router
  ...
  //   .put(AuthToken.verifyToken, user.update)
  .delete(user.deleteAll);

router.route("/:id").put(AuthToken.verifyToken, user.update);
// SIGN UP/ LOGIN
...
router.route("/cart/:id").delete(AuthToken.verifyToken, user.deleteCart);
